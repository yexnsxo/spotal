const EmotionCard = ({ placeName, status, address, summary, tags = [] }) => {
  return (
    <div className='bg-white w-[92.56vw] py-[1.78vh] flex items-center justify-center gap-[2.56vw] rounded-[20px] shadow-[0_4px_4px_rgba(0,0,0,0.1)]'>
      <img className='w-[35.9vw] h-[14.34vh] rounded-[10px] bg-gray-100' />
      <div className='flex flex-col gap-[0.91vh]'>
        <div className='flex justify-between items-center bg-primary-300 w-[48.2vw] h-[3.87vh] py-[1.9vh] px-[4vw] rounded-[10px]'>
        ...
        <div className='flex flex-col gap-[0.6vh] bg-primary-300 rounded-[10px] w-[48.2vw] px-[4.36vw] py-[1.3vh]'>
          ...
          <div className='flex items-baseline w-[40vw]'>
            ...
            <span className='font-[SemiBold] text-[10px] text-gray-700 truncate min-w-0 hover:whitespace-pre-wrap hover:overflow-visible'>
              {summary}
            </span>
          </div>
